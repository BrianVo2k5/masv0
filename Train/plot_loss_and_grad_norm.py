...
file_path = r'C:\Users\ADMIN\Documents\GitHub\masv0\Train\runs\bart-lora\checkpoint-500\trainer_state.json'
...
def plot_training_loss(json_path):
    ...
    ax1.plot(steps, losses, marker='o', linestyle='-', color='#1f77b4', linewidth=2)
    ...
    ax2.plot(steps, grad_norms, marker='s', linestyle='-', color='#ff7f0e', linewidth=2)
